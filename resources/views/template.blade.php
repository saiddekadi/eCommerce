...
<html>
<head>
<title>Electoro store-Panneau d'administration</title>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="/storage/{{$user->image}}"  height="50" width="60" alt=""> </span> 
												<div class="user-name">
													<p>{{ $user->nom }}</p>
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="{{ route('user.edit') }}"><i class="fa fa-user"></i> Profil</a> </li> 
...
<div class="market-updates">
                    ...
                    <div class="col-md-4 market-update-gd">
                        ...
                        <div class="col-md-8 market-update-left">
                            ...
                            <h4>Commandes<br> enregistrées</h4>
                            <p></p>
                        </div>
                            <div class="col-md-4 market-update-right">
                                <i class="fa fa-file-text-o"> </i>
		        ...
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Categories</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         ...
		         <li><a href="#"><i class="fa fa-shopping-cart"></i><span>Commandes</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	<ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="{{ route( 'commande.create' ) }}">Ajouter</a></li>
			            <li id="menu-academico-boletim" ><a href="{{ route( 'commande.index' ) }}">Lister</a></li>
		             </ul>
		         </li>
