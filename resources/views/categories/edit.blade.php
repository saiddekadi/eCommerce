               ...
               <div class="work-progres">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-primary">	
                                    <div class="panel-heading" style="text-align: center;">Modifier une categorie</div>
                                    <div class="panel-body"> 
                                        <div class="col-sm-12">
                                            {!! Form::model($categorie, ['route' => ['categorie.update', $categorie->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}	
                                            <div class="form-group {!! $errors->has('type') ? 'has-error' : '' !!}">
                                                {!! Form::text('type', null, ['class' => 'form-control', 'placeholder' => 'Types']) !!}
