...
<div class="terms py-sm-5 py-4">
    <div class="container py-xl-4 py-lg-2">
        ...
        <!-- //tittle heading -->
        <h6 class="my-md-4 my-3">Politique de Confidentialité</h6>
        <p class="font-weight-light pl-sm-4 mb-2">We value the trust you place in us. Thats why we insist upon the highest standards for secure transactions and customer
        ...
        <p class="font-weight-light pl-sm-4 mb-2">If you are going to use a passage of Lorem Ipsum, you need to be sure there isnt anything embarrassing hidden in the
        ...
        <p class="font-weight-light pl-sm-4 mb-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,
            by injected humour, or randomised words which dont look even slightly believable. If you are going to use a passage
        ...
        <ol start="1" class="pl-sm-4 pl-3">
            <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry.it has a more-or-less normal distribution of
                letters, as opposed Lorem Ipsum has been the industrys standard dummy text ever since the 1500s</li>
        ...
        <p class="font-weight-light pl-sm-4 mb-2"> you need to be sure there isnt anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on
