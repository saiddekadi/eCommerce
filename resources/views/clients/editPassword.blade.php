               ...
               <div class="work-progres">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-primary">	
                                    <div class="panel-heading" style="text-align: center;">Entrer le Nouveau Mot de Pass</div>
                                    <div class="panel-body"> 
                                        <div class="col-sm-12">
                                            {!! Form::model($client, ['route' => ['updatePassword', $client->id], 'method' => 'put', 'class' => 'form-horizontal panel', 'enctype' => 'multipart/form-data']) !!}	
