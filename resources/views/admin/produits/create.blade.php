       ...
       <div class="work-progres">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="text-align: center;">Enregistré un produit</div>
                            <div class="panel-body">
                                <div class="col-sm-12">
                                    {!! Form::open(['route' => 'produit.store', 'class' => 'form-horizontal panel', 'enctype' => 'multipart/form-data']) !!}
                                    <div class="form-group {!! $errors->has('categorie_id') ? 'has-error' : '' !!}">
                                            <select name="categorie_id" id="categorie_id" class="form-control">
                                                @foreach($categories as $categorie)
                                                    <option value="{{ $categorie->id }}">{{ $categorie->type }}</option>
                                                @endforeach
                                                <a href="{{ route( 'categorie.create' ) }}">Nouvelle categorie</a>
                                            </select>
