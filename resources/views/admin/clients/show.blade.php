            ...
            <div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  Formulaire de detail d'un client
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-primary">
                                    <div class="panel-heading" style="text-align: center;">Fiche d'utilisateur</div>
                                    <div class="panel-body">
                                        <p><h4><b>Nom :</b> {{ $client->nom }}</h4></p>
                                        <p><h4><b>Prenom :</b> {{ $client->prenom }}</h4></p>
                                        <p><h4><b>Telephone :</b> {{ $client->tel }}</h4></p>
                                        <p><h4><b>Adresse :</b> {{ $client->adresse }}</h4></p>
                                        <p><h4><b>Email :</b> {{ $client->email }}</h4></p>
                                    </div>
                                </div>
